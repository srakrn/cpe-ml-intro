...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			\includegraphics[width=1.0\textwidth]{imgs/ann.png}
		\end{figure}
		\column{0.65\textwidth}
			This seems complex, right? We'll get started a little by little...
	\end{columns}
\end{frame}

\begin{frame}
	\frametitle{Perceptron}
	\includegraphics[width=1.0\textwidth]{imgs/perceptron.pdf}
\end{frame}
